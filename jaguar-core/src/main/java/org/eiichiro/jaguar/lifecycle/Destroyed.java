 ...
 * {@code @Destroyed} event is raised by the {@link Context} after all 
 * components on the context have been passivated (The contexts that cannot 
 * detect their passivation such as {@link Prototype} and {@link Thread} will 
 ...
 * 
 * There are several conventions on {@code @Destroyed} event listener method 
 * declaration: 
 * <ul>
